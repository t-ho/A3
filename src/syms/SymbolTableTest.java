...
public class SymbolTableTest extends TestCase {
    ...
    public void testGet() {
        ...
        symtab.getCurrentScope().addConstant( "e", new Position(0), Predefined.INTEGER_TYPE, 42 );
        ...
        one = new ProcedureEntry( "one", Position.NO_POSITION, 
                        symtab.getCurrentScope() );
        symtab.newScope( one );
        symtab.getCurrentScope().addConstant( "e", new Position(0), Predefined.BOOLEAN_TYPE, 0 );
        ...
        two = new ProcedureEntry( "two", Position.NO_POSITION, 
                symtab.getCurrentScope() );
        symtab.newScope( two );
        symtab.getCurrentScope().addConstant( "e", new Position(0), Predefined.INTEGER_TYPE, 27 );
    ...
    public void testAddType() {
        ...
        symtab.getCurrentScope().addType( "e", new Position(0), Predefined.INTEGER_TYPE );
    ...
    public void testAddVariable() {
        ...
        symtab.getCurrentScope().addVariable( "e", new Position(0), refInt );
        ...
        symtab.getCurrentScope().addVariable( "f", new Position(0), refInt );
        symtab.getCurrentScope().resolveScope();
        SymEntry.VarEntry f = symtab.getCurrentScope().lookupVariable( "f" );
        checkVariable( f, "f", 1, refInt, 1, 2 );
        
        symtab.getCurrentScope().addVariable( "g", new Position(0), refInt );
        symtab.getCurrentScope().resolveScope();
    ...
    public void testAddProcedure() {
        ...
        symtab.getCurrentScope().addProcedure( "e", new Position(0) );
